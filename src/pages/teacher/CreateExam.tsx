...
import { getCurrentUser, generateId, saveExam, Question } from '@/utils/localStorage';
...
const CreateExam = () => {
  ...
  const onSubmit = (values: z.infer<typeof formSchema>) => {
    ...
    toast({
      ...
      description: 'Your new exam is now available for students.',
    });
    ...
    <Layout>
      <div className="container py-8">
        ...
        <div className="grid grid-cols-1 gap-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Finalize Exam</CardTitle>
              <CardDescription>
